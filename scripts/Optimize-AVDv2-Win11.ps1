...
- Ensure this script is run for version 20H1 
#>
...
C:\temp\optimize\Virtual-Desktop-Optimization-Tool-main\Windows_VDOT.ps1 -AcceptEULA -WindowsVersion $WinVersion -Optimizations "AppxPackages","ScheduledTasks","DefaultUserSettings","Autologgers","Services","LGPO","DiskCleanup"
