...
foreach ($aibtemplate in Get-ChildItem -Recurse -Filter '*.json' -File -Exclude 'Win11*', 'X_*', 'aib*','*publish*', 'Readme.md', 'scripts', '*parameters*', 'singleApp*', '*.ps1', 'RoleDefinition.json','VSWorkspaceState.json') {
