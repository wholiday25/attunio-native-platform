...
$ImageTemplateName = "aibRDSUnifiedDesktop"
...
(Get-Content aibRDSUnifiedDesktop.parameters.json).replace('[IMAGEID]', $parentversionid) | Set-Content aibRDSUnifiedDesktop.parameters.json
