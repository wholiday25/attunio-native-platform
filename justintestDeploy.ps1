...
$ImageTemplateName = "justintestDeploy"
...
(Get-Content justintestDeploy.parameters.json).replace('[IMAGEID]', $parentversionid) | Set-Content justintestDeploy.parameters.json
