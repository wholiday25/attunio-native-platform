...
$ImageTemplateName = "DeveloperNSE"
...
$location = "eastus"
$parentversionid = (Get-AzGalleryImageVersion -ResourceGroupName $sharedimagegalleryRSG -GalleryName $sharedimagegallery -GalleryImageDefinitionName "EntDesktopWindows11V2").Id | Sort-Object -Descending | select-object -First 1
